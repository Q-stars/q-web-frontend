    ...
    <div>
      ...
      <div className={`${styles.sectionText} ${styles.whitepaperBg}`}>
        ...
        <section>
          ...
          <p>
            Despite the potential, the path to actualizing personalized LLMs has
            been obstructed by two significant hurdles:
          </p>
          ...
          <p>
            ...
            stored and managed in a way that restricts user access and utility.
            Such a scenario severely limits the ability of individuals to employ
            their own data for training personalized LLMs, consequently stifling
            the advancement of user-specific language models.
          </p>
          <p>
            ...
            are often beyond the capabilities of these devices. This gap between
            the resource needs for personalized LLMs and the available
        ...
        <section>
          ...
          <p>
            Addressing these challenges, Q* introduces a groundbreaking solution
            that harmonizes decentralized data ownership with sparse network
            training. This innovative approach empowers individuals to leverage
            their own data, overcoming the constraints of corporate-controlled,
            centralized data repositories. Furthermore, Q*&apos;s method
            significantly reduces the computational and storage demands, making
            it viable for anyone with a standard personal device to not only
            train but also host their own personalized LLMs. This advancement
            marks a pivotal shift in the democratization of language model
            technology, paving the way for a future where personalized digital
            experiences are the norm, not the exception.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            parameters can be successfully distilled into a more compact, dense
            model with hundreds of millions of parameters. This section delves
            into the specific process of training a dense, personalized LLM by
            distilling knowledge from a larger, sparse LLM.
          </p>
          <p>
            To clarify our methodology, we introduce two key terms: the
            &quot;Personalized Q Network&quot; and the &quot;Teacher
            Model.&quot; The Personalized Q Network refers to the end product of
            our distillation process — a dense, efficient personalized LLM
          ...
          <p>
            ...
            predictions. Task prefixes, like [label] and [rationale], are added
            to inputs to help the model distinguish between the two tasks.
          </p>
          <p>
          ...
          <p className={styles.inlineRow}>
            ...
            teacher, {subscript('y', 'i')} represents the desired output label.
            Let {formula('f')} denotes the Q network. The rationalel prediction
            loss can be framed as
          </p>
          <Image
            className={styles.inline}
            src="/math/math_9.jpg"
        ...
        <section>
          ...
          <p>
            ...
            members&apos; personal data, which is stored off-chain and encrypted
          ...
          <p>
            ...
            burn Q* tokens, initiating a cycle that benefits data volume, model
            quality, and token deflation. Increased data contributions enhance
            the model&apos;s performance, leading to more frequent usage of the
            model. This, in turn, results in more Q* tokens being burned,
            driving token deflation and fostering a sustainable ecosystem.
          </p>
          <p>
            Tokens are distributed in epochs. During each epoch,
            community-contributed data trains the personalized Q network. The
            network records loss during each training iteration. At epoch&apos;s
            end, data points causing loss above the epoch&apos;s average loss
            are rewarded. The reward for each data point is proportional to its
            loss weight among all qualifying data points, multiplied by the
            total epoch rewards. This system encourages the submission of unique
            data, pushing the network to learn and adapt.
          </p>
          <p>
          ...
          <p className={styles.inlineRow}>
            ...
            that can be released within each epoch, and let L denotes the total
            loss of all data points qualifying for token rewards. The total
            amount of tokens allocated within that epoch is determined by the
            following formula:
          </p>
          <Image
            className={styles.inline}
        ...
        <section>
          ...
          <p className={styles.inlineRow}>
            ...
            the model {subscript('M', 'i')}, which we’ll discuss in more detail
            in the next section. The utility value of {subscript('D', 'i')} is
            then computed as the summation of utility values of all models that
            utilizes {subscript('D', 'i')}, which is
          </p>
          <Image
          ...
          <p className={styles.inlineRow}>
            ...
            Tokens allocated to contributors of {subscript('D', 'i')} is
          </p>
          <Image
            src="/math/math_2.jpg"
            alt="Math formula"
        ...
        <section>
          ...
          <p>
            It can be shown the language model policy has a closed-form solution
          </p>
          <Image
          ...
          />
          <p>
            Plugging this into the human preference distribution, we end up with
          </p>
          <Image
        ...
        <section>
          ...
          <p>
            ...
            holders to propose Q* Improvement Proposals (IIPs). These IIPs play
        ...
        <section>
          ...
          <p>
            Q*.ai stands out as a pioneering platform, not just in democratizing
            access to LLMs but also in driving innovation and collaboration
            within the ML community. Its unique approach of combining
            decentralized technologies with ML development paves the way for a
            more inclusive, efficient, and transparent ecosystem in the realm of
          ...
          <table>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <p>
                    AI Sparse Network researcher, AI model training engineer and
              ...
              <tr>
                ...
                <td>
                  <p>
                    for those who performed work for Q and powered or developed
              ...
              <tr>
                ...
                <td>
                  <p>
                    donations to highly regarded institutions and organizations
                  </p>
                  <i>Cliff/Vest: 1 yr cliff and 4 yr vest</i>
                </td>
              </tr>
              <tr>
                ...
                <td>10%</td>
                <td>
                  Support activities in line with the Foundation&apos;s mission,
                  as detailed in the previous series blog
                </td>
              </tr>
              <tr>
                <td>Unallocated</td>
