    ...
    <div>
      ...
      <div className={`${styles.sectionText} ${styles.aboutBg}`}>
        ...
        <section>
          ...
          <p>
            Describes Informy.ai’s mission to provide SMBs with user-friendly AI
        ...
        <section>
          ...
          <p>
            ...
            collection to crowdsourced model contributions, incentivized through
        ...
        <section>
          ...
          <p>
            Addresses the evolving landscape of LLM development and Informy.ai’s
        ...
        <section>
          ...
          <p>
            ...
            LLM access and fostering innovation and collaboration within the ML
            community.
          </p>
        </section>
      </div>
